...
let resourceTitle = document.getElementById('resource-title');
let resourceDescription = document.getElementById('resource-description');
let resourceLink = document.getElementById('resource-link');
